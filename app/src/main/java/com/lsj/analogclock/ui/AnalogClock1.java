...
public class AnalogClock1 extends View {
    ...
    public AnalogClock1(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public AnalogClock1(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
